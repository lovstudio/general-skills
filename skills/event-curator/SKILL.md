...
5. If the command prints `error: skill 'event-curator' not installed`, the encrypted bundle isn't on disk yet. Tell the user:
   > ```
   > npx lovstudio skills add event-curator -g -y     # 只装这一个
