...
| ![Free](https://img.shields.io/badge/Free-green) | [`any2docx`](https://github.com/lovstudio/any2docx-skill) | Markdown → professionally styled DOCX (Word) with CJK support. |
...
| ![Free](https://img.shields.io/badge/Free-green) | [`pdf2png`](https://github.com/lovstudio/pdf2png-skill) | PDF → single vertically concatenated PNG. macOS CoreGraphics, ~20x faster than pdftoppm. |
| ![Free](https://img.shields.io/badge/Free-green) | [`png2svg`](https://github.com/lovstudio/png2svg-skill) | PNG → high-quality SVG with background removal and spline curves. |
...
| ![Paid](https://img.shields.io/badge/Paid-blueviolet) | [`write-book`](https://github.com/lovstudio/write-book-skill) | Write multi-chapter books (technical, tutorial, monograph) / 逐章写书，支持多种风格 |
| **Meta Skills / 元技能** | | |
