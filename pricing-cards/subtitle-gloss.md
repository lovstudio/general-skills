# Skill Pricing Card：subtitle-gloss

| 项目 | 结论 |
| --- | --- |
| 版本 / 交付单元 | 0.8.0 / 单项 Skill 完整交付，含当前版本的安装与使用说明 |
| 目标买家 | 使用「英语学习字幕」完成 General 任务的人 |
| 建议价格 | ¥0.99 / 次购买 |
| 稳定价格带 | ¥0.99 |
| 渠道 | LovStudio 目录；Pro 同步 WorkBuddy 与 SkillPay |
| 置信度 | medium |
...
- 当前价格处在标准单项 Skill 交付位置，不把源码长度或提示词数量当作价值。
...
一个可复用的英语学习字幕 Skill：输入视频或原字幕和学习者 Profile，只解释必要词汇，保留原时间轴；明确开启艺术层后，可生成不剧透的人物艺术卡片、可选品牌水印和播放器兼容的 ASS 字幕。

交付边界：结果依赖输入字幕、学习者 Profile、影片上下文和可用字体；联网检索与视频证据按实际条件处理，复杂压制和第三方服务费用另计。

维护说明：随字幕格式、播放器兼容性、字体和用户反馈变化复评；小版本更新通常沿用原交付范围。

## 渠道与复评

- 首发测试价：¥0.99，先观察真实复用与支持负担。
- 复评触发：版本变化、连续 10 次真实使用或播放器兼容问题明显增加时复评。
- 证据缺口：继续积累不同播放器、字体和自定义品牌名下的真实渲染反馈。
